...
/**
 * MarkovChain struct represents a Markov chain.
 * It contains a linked list database of MarkovNodes.
 */
...
/**
 * MarkovNode struct represents a node in the Markov chain.
 * It contains the data and a frequency list of subsequent nodes.
 */
typedef struct MarkovNode {
 char *data;  // The data stored in the node
 // List of frequencies for next possible nodes
 struct MarkovNodeFrequency *frequency_list;
 int size_NodesFreq;  // Size of the frequency list
 // any other fields you need
} MarkovNode;

/**
 * MarkovNodeFrequency struct represents the frequency of transitions
 * from a MarkovNode to another MarkovNode.
 */
typedef struct MarkovNodeFrequency {
 struct MarkovNode *markov_node;//Pointer to the next node in the Markov chain
 int frequency;  // Frequency of the transition to the next node
 // any other fields you need
} MarkovNodeFrequency;
